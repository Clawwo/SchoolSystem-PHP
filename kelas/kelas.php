...
<nav id="sidebar">
    <ul>
      ...
      <!-- <div class="">
        <form action="../login/adminl.php" method="post">
...
<div class="top">
  <h1>Tabel Kelas</h1>
  <div class="kn">
        <a class="add" href="../kelas/tambahkelas.php">
...
while($row = mysqli_fetch_array($data)){
  ...
  <tr>
      ...
      <td><a href="../kelas/edit-kelas.php?id=<?php echo $row['id_kelas']; ?>">
      <i data-feather="edit-3"></i>
      </a>
      <a href="../kelas/hapus-kelas.php" onclick="confirmDelete (<?php echo $row['id_kelas']; ?>, event)">
...
<script>
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = 'hapus-kelas.php?id=' + nis;
      }
    });
  }
</script>
