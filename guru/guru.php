...
<div class="top">
  <h1>Tabel Guru</h1>
  <div class="kn">
        <a class="add" href="../guru/tambahguru.php">
...
<table>
    ...
    <tr>
        ...
        <td><a href="../guru/edit-guru.php?nis=<?php echo $row['Id_guru']; ?>">
            <i data-feather="edit-3"></i>
        </a>
        <a href="../guru/hapus-guru.php" onclick="confirmDelete (<?php echo $row['Id_guru']; ?>, event)">
...
<script>
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = 'hapus-guru.php?nis=' + nis;
      }
    });
  }
</script>
